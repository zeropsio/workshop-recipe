...
/** Copy-paste prompts for ZCP during the workshop, in order (see repo PROMPTS.md). */
export const WORKSHOP_PROMPTS: WorkshopPrompt[] = [
  {
    id: 1,
    title: "Slide count in the editor",
    text: `In the Deck Renderer app (/app), show a live slide count in the markdown
...
3. Verify on /app: the sample deck shows "3 slides"; deleting a \`---\` divider
  ...
  },
  {
    ...
    text: `Switch the workshop frontend from the current light theme to a dark theme:
...
4. Verify /, /app, /prompts, and /capabilities look cohesive in dark mode
  ...
  {
    id: 3,
    title: "Basic auth on the deck app",
    text: `Protect the Deck Renderer API with HTTP Basic Auth and make the frontend ask
